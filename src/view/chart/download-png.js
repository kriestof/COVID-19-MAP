...
export default function downloadChartPng(MARGIN) {
  ...
  downloadSvg.attr("height",chartSvg.node().height.baseVal.value + 100)

  downloadSvg.selectAll(".remove-label").remove()
  downloadSvg.selectAll(".text-label").attr("x", 40)

  downloadSvg.selectAll(".y-axis, .x-axis, .country-lines, .legend").attr("transform", "translate(0, 50)")
  ...
  downloadSvg
    ...
    downloadSvg
      ...
      .attr("y", downloadSvg.attr("height")-27).attr("x", MARGIN.x)
      .attr("fill", "#595959")
      .style("font-family", "sans-serif")
      .style("font-size", "12px")
    ...
    downloadSvg
      ...
      .attr("y", downloadSvg.attr("height")-7).attr("x", MARGIN.x)
      .attr("fill", "#595959")
      .style("font-family", "sans-serif")
      .style("font-size", "12px")
