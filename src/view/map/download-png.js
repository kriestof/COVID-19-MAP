...
export default function downloadMapPng(indicatorList) {
  ...
  downloadSvg.attr("width", mapSvg.node().width.baseVal.value*SCALE)
  downloadSvg.attr("height",(mapSvg.node().height.baseVal.value+110)*SCALE)
  ...
  downlaodSvgG
    .append("text")
    .attr("y", downloadSvg.attr("height")/SCALE-48).attr("x", 20)
  ...
  downlaodSvgG
    .append("text")
    .attr("y", downloadSvg.attr("height")/SCALE-28).attr("x", 20)
  ...
  downlaodSvgG
    .append("text")
    .attr("y", downloadSvg.attr("height")/SCALE-8).attr("x", 20)
